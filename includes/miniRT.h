...
/*   Updated: 2026/02/11 21:20:10 by stakada          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			rotate_object(t_obj *objects, int index, t_vec3 axis,
					double angle);
void			resize_object(t_obj *objects, int index, double delta,
					int h_mode);
